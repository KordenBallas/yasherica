...
- `PlaceholderIdle.anim` / `.controller` — looping 2s idle authored as sampled quaternion `localRotation` curves: spine sway, head nod, arm swings, ear twitches, wing flaps, phase-offset tail wag. Makes swap-continuity and appendage deformation visually verifiable.
