...
namespace Combat.Battlefield
{
    ...
    public class HexCellHighlightedState : HexCellStateBase
    {
        ...
        public HexCellHighlightedState(HighlightType type, Color color, Color originalColor)
        {
        ...
        {
            cell.IsActive = true;
            Debug.Log($"[HexCellHighlightedState] Cell {cell.Coordinates} highlighted as {highlightType}");
        }
